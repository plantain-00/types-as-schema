...
`
export const indexTemplateHtml = `<div class="app"><textarea class="source" v-model="source"></textarea><div class="result"><button @click="generate()">generate</button><div class="options"><select v-model="selectedOption"><option v-for="option in options" :value="option" :key="option">{{option}}</option></select></div><pre class="protobuf" v-if="selectedOption === 'protobuf'">{{protobuf}}</pre><pre class="json-schema" v-if="jsonSchema">{{jsonSchema}}</pre><pre class="graphql-schema" v-if="selectedOption === 'graphql schema'">{{graphqlSchema}}</pre><pre class="reason-types" v-if="selectedOption === 'reason types'">{{reasonTypes}}</pre><pre class="ocaml-types" v-if="selectedOption === 'ocaml types'">{{ocamlTypes}}</pre><pre class="rust-types" v-if="selectedOption === 'rust types'">{{rustTypes}}</pre><pre class="mongoose-schema" v-if="selectedOption === 'mongoose schema'">{{mongooseSchema}}</pre><pre class="graphql-root-type" v-if="selectedOption === 'graphql root type'">{{graphqlRootType}}</pre><pre class="swagger-doc" v-if="selectedOption === 'swagger doc'">{{swaggerDoc}}</pre><pre class="custom" v-if="selectedOption === 'custom'">{{custom}}</pre><pre class="typescript" v-if="selectedOption === 'typescript'">{{typescript}}</pre><pre class="markdown" v-if="selectedOption === 'markdown'">{{markdown}}</pre></div></div>`
/* eslint-enable */
// tslint:enable
