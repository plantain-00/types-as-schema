...
module.exports = {
  build: [
    ...
    revStaticCommand,
    {
      default: 'node ./dist/index.js demo/cases.ts demo/case2.ts --json demo/ --debug demo/debug.json --protobuf demo/cases.proto --graphql demo/cases.gql --reason demo/cases.re --ocaml demo/cases.ml --rust demo/cases.rs --mongoose demo/cases.mongoose.ts',
  ...
  lint: {
    ...
    typeCoverageOnline: 'type-coverage -p online --at-least 91'
  },
  test: [
    'tsc -p spec',
    'jasmine',
